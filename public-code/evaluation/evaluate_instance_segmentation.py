...
def main(ar):
    ...
    groundTruthImgList = glob.glob(f'{ar.gts}/*/*_gtFine_instancelevel3Ids.png')
    predictionImgList = [ gt.replace('_gtFine_instancelevel3Ids.png','_leftImg8bit.txt').replace(ar.gts, ar.preds) for gt in groundTruthImgList ]
